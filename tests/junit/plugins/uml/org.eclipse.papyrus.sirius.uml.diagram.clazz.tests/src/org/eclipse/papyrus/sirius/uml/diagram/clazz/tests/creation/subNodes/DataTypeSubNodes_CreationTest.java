...
/**
 * This class tests the creation of subnodes for DataType Node
 */
@PluginResource("resources/creation/subNodes/datatypeSubNodes/datatypeSubNodes.di")
public class DataTypeSubNodes_CreationTest extends AbstractCreateNodeTests {
	...
	protected EObject getTopGraphicalContainer() {
		...
		Assert.assertEquals(MappingTypes.DATATYPE_NODE_TYPE, element.getMapping().getName());
		return element;
	}
	...
	public void createPropertyLabelNodeTest() {
		final EObject graphicalContainer = getSubNodeOfGraphicalContainer(MappingTypes.DATATYPE_NODE_ATTRIBUTES_COMPARTMENT_TYPE);
	...
	public void createOperationLabelNodeTest() {
		final EObject graphicalContainer = getSubNodeOfGraphicalContainer(MappingTypes.DATATYPE_NODE_OPERATIONS_COMPARTMENT_TYPE);
