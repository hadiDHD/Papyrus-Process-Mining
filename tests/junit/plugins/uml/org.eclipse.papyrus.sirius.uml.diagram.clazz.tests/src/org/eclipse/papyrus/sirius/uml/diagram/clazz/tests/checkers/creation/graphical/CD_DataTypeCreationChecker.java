...
/**
 * Creation checker for the graphical node CD_DataType
 */
public class CD_DataTypeCreationChecker extends AbstractDNodeContainerCreationChecker {
	 ...
	 */
	public CD_DataTypeCreationChecker(final Diagram diagram, final EObject graphicalParent) {
	...
	public String getNodeMappingType() {
		return MappingTypes.DATATYPE_NODE_TYPE;
	}
	...
	public List<String> getNodeCompartmentTypes() {
		...
		compartments.add(MappingTypes.DATATYPE_NODE_ATTRIBUTES_COMPARTMENT_TYPE);
		compartments.add(MappingTypes.DATATYPE_NODE_OPERATIONS_COMPARTMENT_TYPE);
		return compartments;
	}
}