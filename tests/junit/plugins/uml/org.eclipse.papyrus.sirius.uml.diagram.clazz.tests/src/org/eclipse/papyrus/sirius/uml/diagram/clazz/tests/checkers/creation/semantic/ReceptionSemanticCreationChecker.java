...
/**
 * Creation checker for UML Reception
 */
public class ReceptionSemanticCreationChecker extends AbstractSemanticNodeCreationChecker {
	 ...
	 */
	public ReceptionSemanticCreationChecker(final EObject expectedOwner) {
		super(expectedOwner);
	}
	...
	protected void validateSemanticElementInstance(final EObject semanticElement) {
		Assert.assertTrue(NLS.bind("The created element must be a UML Reception instead of a {0}.", semanticElement.eClass().getName()), semanticElement instanceof org.eclipse.uml2.uml.Reception); //$NON-NLS-1$
	}
	...
	protected EReference getContainmentFeature() {
		if (this.semanticOwner instanceof org.eclipse.uml2.uml.Class) {
			return UMLPackage.eINSTANCE.getClass_OwnedReception();
		} else if (this.semanticOwner instanceof Interface) {
			return UMLPackage.eINSTANCE.getInterface_OwnedReception();
		}
		return null;
	}
