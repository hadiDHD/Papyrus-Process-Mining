...
public class PrimitiveTypeSubNodes_CreationTest extends AbstractSubNodeListElementCreationTests<org.eclipse.uml2.uml.PrimitiveType>{
	...
	public void createPropertyLabelNodeTest() {
		final DDiagramElement createdElement = createSubNode(MappingTypes.PRIMITIVETYPE_NODE_ATTRIBUTES_COMPARTMENT_TYPE, CreationToolsIds.CREATE_PROPERTY_TOOL, MappingTypes.PROPERTY_LABEL_NODE_TYPE);
	...
	public void createOperationLabelNodeTest() {
		final DDiagramElement createdElement = createSubNode(MappingTypes.PRIMITIVETYPE_NODE_OPERATIONS_COMPARTMENT_TYPE, CreationToolsIds.CREATE_OPERATION_TOOL, MappingTypes.OPERATION_LABEL_NODE_TYPE);
		final EObject semantic = createdElement.getSemanticElements().get(0);
