...
/**
 * Creation checker for the graphical node CD_DurationObservation
 */
public class CD_DurationObservationCreationChecker extends AbstractDNodeCreationChecker {
	 ...
	 */
	public CD_DurationObservationCreationChecker(final Diagram diagram, final EObject container) {
	...
	protected String getNodeMappingType() {
		return MappingTypes.DURATIONOBSERVATION_NODE_TYPE;
	}
