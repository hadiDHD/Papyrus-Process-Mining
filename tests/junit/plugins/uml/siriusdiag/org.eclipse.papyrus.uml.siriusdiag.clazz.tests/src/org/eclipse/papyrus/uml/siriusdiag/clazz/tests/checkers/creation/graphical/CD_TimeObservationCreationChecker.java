...
/**
 * Creation checker for the graphical node CD_TimeObservation
 */
public class CD_TimeObservationCreationChecker extends AbstractDNodeCreationChecker {
	 ...
	 */
	public CD_TimeObservationCreationChecker(Diagram diagram, EObject container) {
	...
	protected String getNodeMappingType() {
		return MappingTypes.TIMEOBSERVATION_NODE_TYPE;
	}
