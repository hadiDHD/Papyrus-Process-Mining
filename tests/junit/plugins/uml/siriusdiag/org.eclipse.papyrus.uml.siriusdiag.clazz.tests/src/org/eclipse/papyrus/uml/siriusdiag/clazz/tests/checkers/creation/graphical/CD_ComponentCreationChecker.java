...
/**
 * Creation checker for the graphical node CD_Component
 */
public class CD_ComponentCreationChecker extends AbstractDNodeContainerCreationChecker {
	 ...
	 */
	public CD_ComponentCreationChecker(final Diagram diagram, final EObject graphicalParent) {
	...
	public String getNodeMappingType() {
		return MappingTypes.COMPONENT_NODE_TYPE;
	}
	...
	public List<String> getNodeCompartmentTypes() {
		...
		compartments.add(MappingTypes.COMPONENT_NODE_ATTRIBUTES_COMPARTMENT_TYPE);
		compartments.add(MappingTypes.COMPONENT_NODE_OPERATIONS_COMPARTMENT_TYPE);
		compartments.add(MappingTypes.COMPONENT_NODE_NESTED_CLASSIFIERS_COMPARTMENT_TYPE);
		return compartments;
	}
}