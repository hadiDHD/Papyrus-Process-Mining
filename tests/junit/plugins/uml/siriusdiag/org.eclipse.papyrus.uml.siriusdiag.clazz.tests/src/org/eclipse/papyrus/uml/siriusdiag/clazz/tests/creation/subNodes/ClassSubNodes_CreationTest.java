...
public class ClassSubNodes_CreationTest extends AbstractSubNodeListElementCreationTests<org.eclipse.uml2.uml.Class>{
	...
	public void createPropertyLabelNodeTest() {
		final DDiagramElement createdElement = createSubNodeInDNodeContainer(MappingTypes.CLASS_NODE_ATTRIBUTES_COMPARTMENT_TYPE, CreationToolsIds.CREATE__PROPERTY__TOOL, MappingTypes.PROPERTY_LABEL_NODE_TYPE);
	...
	public void createOperationLabelNodeTest() {
		final DDiagramElement createdElement = createSubNodeInDNodeContainer(MappingTypes.CLASS_NODE_OPERATIONS_COMPARTMENT_TYPE, CreationToolsIds.CREATE__OPERATION__TOOL, MappingTypes.OPERATION_LABEL_NODE_TYPE);
		final EObject semantic = createdElement.getSemanticElements().get(0);
	...
	public void createReceptionLabelNodeTest() {
		final DDiagramElement createdElement = createSubNodeInDNodeContainer(MappingTypes.CLASS_NODE_OPERATIONS_COMPARTMENT_TYPE, CreationToolsIds.CREATE__RECEPTION__TOOL, MappingTypes.RECEPTION_LABEL_NODE_TYPE);
		final EObject semantic = createdElement.getSemanticElements().get(0);
	...
	public void createClassLabelNodeTest() {
		final DDiagramElement createdElement = createSubNodeInDNodeContainer(MappingTypes.CLASS_NODE_NESTED_CLASSIFIERS_COMPARTMENT_TYPE, CreationToolsIds.CREATE__CLASS__TOOL, MappingTypes.CLASS_LABEL_NODE_TYPE);
		final EObject semantic = createdElement.getSemanticElements().get(0);
	...
	public void createInterfaceLabelNodeTest() {
		final DDiagramElement createdElement = createSubNodeInDNodeContainer(MappingTypes.CLASS_NODE_NESTED_CLASSIFIERS_COMPARTMENT_TYPE, CreationToolsIds.CREATE__INTERFACE__TOOL, MappingTypes.INTERFACE_LABEL_NODE_TYPE);
		final EObject semantic = createdElement.getSemanticElements().get(0);
	...
	public void createSignalLabelNodeTest() {
		final DDiagramElement createdElement = createSubNodeInDNodeContainer(MappingTypes.CLASS_NODE_NESTED_CLASSIFIERS_COMPARTMENT_TYPE, CreationToolsIds.CREATE__SIGNAL__TOOL, MappingTypes.SIGNAL_LABEL_NODE_TYPE);
		final EObject semantic = createdElement.getSemanticElements().get(0);
	...
	public void createDataTypeLabelNodeTest() {
		final DDiagramElement createdElement = createSubNodeInDNodeContainer(MappingTypes.CLASS_NODE_NESTED_CLASSIFIERS_COMPARTMENT_TYPE, CreationToolsIds.CREATE__DATATYPE__TOOL, MappingTypes.DATATYPE_LABEL_NODE_TYPE);
		final EObject semantic = createdElement.getSemanticElements().get(0);
	...
	public void createEnumerationLabelNodeTest() {
		final DDiagramElement createdElement = createSubNodeInDNodeContainer(MappingTypes.CLASS_NODE_NESTED_CLASSIFIERS_COMPARTMENT_TYPE, CreationToolsIds.CREATE__ENUMERATION__TOOL, MappingTypes.ENUMERATION_LABEL_NODE_TYPE);
		final EObject semantic = createdElement.getSemanticElements().get(0);
	...
	public void createPrimitiveTypeLabelNodeTest() {
		final DDiagramElement createdElement = createSubNodeInDNodeContainer(MappingTypes.CLASS_NODE_NESTED_CLASSIFIERS_COMPARTMENT_TYPE, CreationToolsIds.CREATE__PRIMITIVETYPE__TOOL, MappingTypes.PRIMITIVETYPE_LABEL_NODE_TYPE);
		final EObject semantic = createdElement.getSemanticElements().get(0);
