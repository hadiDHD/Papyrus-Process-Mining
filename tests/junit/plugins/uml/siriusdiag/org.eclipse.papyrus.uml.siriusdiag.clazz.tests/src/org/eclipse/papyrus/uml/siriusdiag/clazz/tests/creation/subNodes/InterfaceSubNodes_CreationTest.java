...
/**
 * This class tests the creation of subnodes for Interface Node
 */
@PluginResource("resources/creation/subNodes/interfaceSubNodes/interfaceSubNodes.di")
public class InterfaceSubNodes_CreationTest extends AbstractCreateNodeTests {
	...
	protected EObject getTopGraphicalContainer() {
		...
		Assert.assertEquals(MappingTypes.INTERFACE_NODE_TYPE, element.getMapping().getName());
		return element;
	}
	...
	public void createPropertyLabelNodeTest() {
		final EObject graphicalContainer = getSubNodeOfGraphicalContainer(MappingTypes.INTERFACE_NODE_ATTRIBUTES_COMPARTMENT_TYPE);
	...
	public void createOperationLabelNodeTest() {
		final EObject graphicalContainer = getSubNodeOfGraphicalContainer(MappingTypes.INTERFACE_NODE_OPERATIONS_COMPARTMENT_TYPE);
	...
	public void createClassLabelNodeTest() {
		final EObject graphicalContainer = getSubNodeOfGraphicalContainer(MappingTypes.INTERFACE_NODE_NESTED_CLASSIFIERS_COMPARTMENT_TYPE);
