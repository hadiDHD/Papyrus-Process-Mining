...
/**
 * Creation checker for UML DurationObservation
 */
public class DurationObservationSemanticCreationChecker extends AbstractSemanticNodeCreationChecker {
	 ...
	 */
	public DurationObservationSemanticCreationChecker(final EObject expectedOwner) {
		super(expectedOwner);
	}
	...
	protected void validateSemanticElementInstance(EObject semanticElement) {
		Assert.assertTrue(NLS.bind("The created element must be a UML DurationObservation instead of a {0}.", semanticElement.eClass().getName()), semanticElement instanceof org.eclipse.uml2.uml.DurationObservation); //$NON-NLS-1$
	}
