...
/**
 * Creation checker for UML Enumeration
 */
public class EnumerationSemanticCreationChecker extends AbstractSemanticNodeCreationChecker {
	 ...
	 */
	public EnumerationSemanticCreationChecker(final EObject expectedOwner) {
		super(expectedOwner);
	}
	...
	protected void validateSemanticElementInstance(EObject semanticElement) {
		Assert.assertTrue(NLS.bind("The created element must be a UML Enumeration instead of a {0}.", semanticElement.eClass().getName()), semanticElement instanceof org.eclipse.uml2.uml.Enumeration); //$NON-NLS-1$
	}
