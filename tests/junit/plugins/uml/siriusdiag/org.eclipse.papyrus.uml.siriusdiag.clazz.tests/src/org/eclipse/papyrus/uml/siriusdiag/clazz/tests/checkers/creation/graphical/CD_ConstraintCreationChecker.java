...
/**
 * Creation checker for the graphical node CD_Constraint
 */
public class CD_ConstraintCreationChecker extends AbstractDNodeCreationChecker {
	 ...
	 */
	public CD_ConstraintCreationChecker(final Diagram diagram, final EObject container) {
	...
	protected String getNodeMappingType() {
		return MappingTypes.CONSTRAINT_NODE_TYPE;
	}
