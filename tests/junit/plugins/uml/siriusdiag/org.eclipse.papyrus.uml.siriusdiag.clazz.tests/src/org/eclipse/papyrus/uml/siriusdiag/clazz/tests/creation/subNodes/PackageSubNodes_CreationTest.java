 ...
 */
@PluginResource("resources/creation/subNodes/packageSubNodes/packageSubNodes.di")
public class PackageSubNodes_CreationTest extends AbstractCreateNodeTests {

	private static final String SEMANTIC_ONWER_NAME = "Package1"; //$NON-NLS-1$

	private static final String DIAGRAM_NAME = "PackageSubNodesDiagram"; //$NON-NLS-1$
	...
	protected EObject getTopGraphicalContainer() {
		...
		Assert.assertEquals(MappingTypes.PACKAGE_NODE_TYPE, element.getMapping().getName());
		return element;
	}
	...
	public void createClassNodeTest() {
		final EObject graphicalContainer = getSubNodeOfGraphicalContainer(MappingTypes.PACKAGE_NODE_PACKAGEDELEMENTS_COMPARTMENTS_TYPE);
