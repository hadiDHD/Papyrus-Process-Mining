...
/**
 * This class tests the creation of subnode for DataType Node
 */
@PluginResource("resources/creation/subNodes/datatypeSubNodes/datatypeSubNodes.di")
public class DataTypeSubNodes_CreationTest extends AbstractSubNodeListElementCreationTests<org.eclipse.uml2.uml.DataType>{

	private static final String SEMANTIC_ONWER_NAME = "DataType1"; //$NON-NLS-1$

	private static final String DIAGRAM_NAME = "DataTypeSubNodesDiagram"; //$NON-NLS-1$
	 ...
	 */
	@Override
	protected org.eclipse.uml2.uml.DataType getSemanticOwner() {
		return (org.eclipse.uml2.uml.DataType) this.root.getMember(SEMANTIC_ONWER_NAME);
	}
	
	@Test
	@ActiveDiagram(DIAGRAM_NAME)
	public void createPropertyLabelNodeTest() {
		final DDiagramElement createdElement = createSubNodeInDNodeContainer(MappingTypes.DATATYPE_NODE_ATTRIBUTES_COMPARTMENT_TYPE, CreationToolsIds.CREATE__PROPERTY__TOOL, MappingTypes.PROPERTY_LABEL_NODE_TYPE);
	...
	public void createOperationLabelNodeTest() {
		final DDiagramElement createdElement = createSubNodeInDNodeContainer(MappingTypes.DATATYPE_NODE_OPERATIONS_COMPARTMENT_TYPE, CreationToolsIds.CREATE__OPERATION__TOOL, MappingTypes.OPERATION_LABEL_NODE_TYPE);
		final EObject semantic = createdElement.getSemanticElements().get(0);
