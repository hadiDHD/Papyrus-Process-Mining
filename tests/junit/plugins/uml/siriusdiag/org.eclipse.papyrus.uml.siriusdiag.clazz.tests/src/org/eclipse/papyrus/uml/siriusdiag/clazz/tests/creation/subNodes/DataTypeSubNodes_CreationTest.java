...
public class DataTypeSubNodes_CreationTest extends AbstractSubNodeListElementCreationTests<org.eclipse.uml2.uml.DataType>{
	...
	public void createPropertyLabelNodeTest() {
		final DDiagramElement createdElement = createSubNode(MappingTypes.DATATYPE_NODE_ATTRIBUTES_COMPARTMENT_TYPE, CreationToolsIds.CREATE_PROPERTY_TOOL, MappingTypes.PROPERTY_LABEL_NODE_TYPE);
	...
	public void createOperationLabelNodeTest() {
		final DDiagramElement createdElement = createSubNode(MappingTypes.DATATYPE_NODE_OPERATIONS_COMPARTMENT_TYPE, CreationToolsIds.CREATE_OPERATION_TOOL, MappingTypes.OPERATION_LABEL_NODE_TYPE);
		final EObject semantic = createdElement.getSemanticElements().get(0);
