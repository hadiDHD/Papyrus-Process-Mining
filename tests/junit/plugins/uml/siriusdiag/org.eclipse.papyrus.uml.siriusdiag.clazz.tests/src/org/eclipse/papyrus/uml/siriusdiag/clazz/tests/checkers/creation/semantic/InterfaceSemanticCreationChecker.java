...
/**
 * Creation checker for UML Interface
 */
public class InterfaceSemanticCreationChecker extends AbstractSemanticNodeCreationChecker{
	 ...
	 */
	public InterfaceSemanticCreationChecker(final EObject expectedOwner) {
		super(expectedOwner);
	}
	...
	protected void validateSemanticElementInstance(EObject semanticElement) {
		Assert.assertTrue(NLS.bind("The created element must be a UML Interface instead of a {0}.", semanticElement.eClass().getName()), semanticElement instanceof org.eclipse.uml2.uml.Interface); //$NON-NLS-1$	
	}
