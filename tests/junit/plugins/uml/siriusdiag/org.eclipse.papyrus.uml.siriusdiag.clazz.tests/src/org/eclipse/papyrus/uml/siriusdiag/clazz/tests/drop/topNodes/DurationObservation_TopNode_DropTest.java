...
public class DurationObservation_TopNode_DropTest extends AbstractPapyrusTest {
	...
	public void DurationObservation_DropTest() {
		...
		fixture.applyContainerDropDescriptionTool(diagramRepresentation, SemanticDropToolsIds.DROP_DURATIONOBSERVATION_TOOL, diagramRepresentation, elementToBeDropped);
