/******************************************************************************
 * Copyright (c) 2007, 2015, 2022 Borland Software Corporation, Christian W. Damus, and others
 *
 ...
 *****************************************************************************/
package org.eclipse.papyrus.uml.sirius.common.diagram.provider;
...
/**
 * TODO : this class introduce a dependency to the Papyrus sirius integration plugin (oep.infra.siriusdiag.ui) and it should not
 * duplicated and adapted from papyrus : org.eclipse.papyrus.uml.diagram.common.providers.ValidationDecoratorProvider
		...
		PlatformUI.getWorkbench().getDisplay().asyncExec(new Runnable() {
			...
			public void run() {
				try {
					...
					Activator.log.error("Decorator refresh failure", e); //$NON-NLS-1$
				}
			}
		});
	}
	...
	public static class StatusDecorator extends AbstractDecorator implements Observer {
		...
		public void activate() {
			try {
				...
				Activator.log.error("ViewID access failure", e); //$NON-NLS-1$
			}
		...
		public List<Object> getDecoratedElements(Object viewElement) {
			List<Object> decoratedElements = new BasicEList<>();
